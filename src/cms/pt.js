  ...
  editor: {
    ...
    editor: {
      ...
      onPublishingNotReady:
        'Por favor, altere o status para "Pronto" antes de publicar.',
      ...
      onUnpublishing:
        "Tem certeza que deseja cancelar a publicação dessa entrada?",
      ...
      onDeletePublishedEntry:
        "Tem certeza de que deseja excluir esta entrada publicada?",
      ...
      confirmLoadBackup:
        "Um backup local foi recuperado para esta entrada. Deseja usá-lo?",
    },
    editorToolbar: {
  ...
  ui: {
    ...
    toast: {
      ...
      onFailToLoadDeployPreview:
        "Falha ao carregar a pré-visualização: %{details}",
      ...
      onFailToUnpublishEntry:
        "Falha ao cancelar a publicação da entrada: %{details}",
